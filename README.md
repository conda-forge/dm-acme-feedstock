...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dm-acme-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11258&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dm-acme-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dm-acme` can be installed with:

```
conda install dm-acme
```

It is possible to list all of the versions of `dm-acme` available on your platform with:
